...
public class Utils {
    ...
    //AJOUT : calculating a random peer_id
    public static String randomPeerId() {
    	String ramdom_peer_id="" ;
    	Random random ;
    	for(int i=0; i<20; i++) {
    		random= new Random();
            char randomizedCharacter = (char) (random.nextInt(126-33)+33);
            ramdom_peer_id += randomizedCharacter; 
    	}
    	return (ramdom_peer_id); 
    }
    
	static int from2ByteArray(byte[] bytes) {
